...
insert into COMMON_CODEKIND(id,codeKindId,codeKindName) values(COMMON_CODEKIND_SEQ.NEXTVAL,'MSG','訊息管理');
insert into COMMON_CODEKIND(id,codeKindId,codeKindName) values(COMMON_CODEKIND_SEQ.NEXTVAL,'TIT','職稱');
insert into COMMON_CODE(id,codeKindId,codeId,codeName,codeCon1,codeCon2,codeCon3,codeMemo) values(COMMON_CODE_SEQ.NEXTVAL,1,'01','最新消息','','','','');
insert into COMMON_CODE(id,codeKindId,codeId,codeName,codeCon1,codeCon2,codeCon3,codeMemo) values(COMMON_CODE_SEQ.NEXTVAL,1,'02','檔案下載','','','','');
insert into COMMON_CODE(id,codeKindId,codeId,codeName,codeCon1,codeCon2,codeCon3,codeMemo) values(COMMON_CODE_SEQ.NEXTVAL,2,'01','主管/經理','','','','');
insert into COMMON_CODE(id,codeKindId,codeId,codeName,codeCon1,codeCon2,codeCon3,codeMemo) values(COMMON_CODE_SEQ.NEXTVAL,2,'02','職員/員工','','','','');
INSERT INTO COMMON_GROUP (id,groupName,groupDesc,editId,editDate,editTime) VALUES (COMMON_GROUP_SEQ.NEXTVAL,'Administraors','最高權限管理者',null,null,null);
INSERT INTO COMMON_GROUP (id,groupName,groupDesc,editId,editDate,editTime) VALUES (COMMON_GROUP_SEQ.NEXTVAL,'PowerUsers','業務管理者',null,null,null);
INSERT INTO COMMON_GROUP (id,groupName,groupDesc,editId,editDate,editTime) VALUES (COMMON_GROUP_SEQ.NEXTVAL,'Users','一般使用者','系統管理者','0960915','204235');
INSERT INTO COMMON_DEPARTMENT(id,parentId,lev,departmentCode,department,shortName,fullName,fullCode,preFullCode,phone,fax,zip,address,email,notes,homepage,chiefTitle,chiefName,isSchool,schoolType,editId,editDate,editTime) VALUES (COMMON_DEPARTMENT_SEQ.NEXTVAL,null,0,'01','系統預設機關',null,'系統預設機關','0100000000000',null,null,null,null,null,null,'',null,null,null,null,null,null,null,null);
INSERT INTO COMMON_USER (id,userId,userSSN,userPWD,userName,groupId,roleId,deptId,userTitle,userTel,userMobile,userFax,userEmail,takeJobDate,isStop,isDeptManager,isAdministrator,memo,editId,editDate,editTime) VALUES (COMMON_USER_SEQ.NEXTVAL,'admin',null,'edc4f833b30477e0c859c16cfb2a72dfbb8acca6','admin',1,3,1,null,null,null,null,null,null,'N',null,null,'test','admin','0961010','185418');
...
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (2,-11,4,'群組及授權維護作業','../sys/ap/sysap002f.jsp','','','','','','','',1000);
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (3,-11,4,'使用者管理','../sys/ap/sysap001f.jsp','','','','','','','',1000);
...
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (6,-11,5,'共用代碼維護作業','../sys/ca/sysca001f.jsp','','','','','','','',1000);
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (9,-11,5,'機關代碼管理','../sys/ca/deptFrame.jsp','','','','','','','',1000);
...
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (8,-11,7,'訊息公告','../sys/wm/syswm001f.jsp','','','','','','','',1000);
INSERT INTO COMMON_DTREE (id,sysid,pid,name,url,title,target,icon,iconOpen,opened,btnRead,btnWrite,sorted) VALUES (13,-11,7,'訊息傳送','../sys/wm/syswm003f.jsp','','','','','','','',1000);

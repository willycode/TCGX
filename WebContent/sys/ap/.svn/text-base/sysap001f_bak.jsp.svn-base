...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white">
			<input class="field" type="password" name="userPWD" size="12" maxlength="12" value="<%=obj.getUserPWD()%>">		</td>
	...
	<tr>
	  <td class="td_form"><font color="red">*</font>使用者類別：</td>
	  <td class="td_form_white"><select class="field" type="select" name="roleId">
	...
	<tr>
	  ...
	  <td class="td_form_white"><select class="field" type="select" name="isStop">
	...
	<tr>
	  ...
	  <td class="td_form_white"><input name="memo" type="text" class="field" value="<%=obj.getMemo()%>" size="30" maxlength="250"></td>
	  </tr>
	<tr>

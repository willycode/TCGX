...
<div id="queryContainer" style="width:700px;height:300px;display:none">
	...
	<tr>
		<td class="queryTDLable"></font><fmt:message key="CommonUser.deptId"/>：</td>
		<td class="queryTDInput">
	...
	<tr>
		<td class="queryTDLable"></font><fmt:message key="CommonUser.isMgr"/>：</td>
		<td class="queryTDInput">			
...
<tr><td class="bg">
	...
	<tr>
	  	<td class="td_form"><font color="red">*</font><fmt:message key="CommonUser.isMgr"/>：</td>
	  	<td class="td_form_white">

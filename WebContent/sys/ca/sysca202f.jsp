...
<jsp:useBean id="obj"  scope="request" class="com.kangdainfo.common.view.sys.ca.SYSCA202F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.common.view.sys.ca.SYSCA202F)obj.queryOne();	
...
<!--Query區============================================================-->
<div id="parentQueryContainer" style="width:400px;height:150px;display:none">
	...
	<table class="queryTable" border="1">
		<tr>
			...
			<td class="queryTDInput">
				<select class="field_QRO" type="select" name="q_id">
...
<table cellspacing="0" cellpadding="0'" valign="top">
	<tr>
		<td nowrap id="t1" class="tab_border2" width="100"><a href="#" onClick="return checkURL('sysca201f.jsp')">類別基本資料維護</a></td>
		<td nowrap id="t2" class="tab_border1" width="100">代碼基本資料維護</td>
	</tr>
	<tr>
...
<tr><td class="bg" >
	...
	<tr>
		...
		<td class="td_form_white">
			<select class="field_QRO" type="select" name="codeKindID" onChange="setCodeMaxLen();">
				<%=View.getOption("select id, codeKindId||'-'||codeKindName from " + CommonCodeKind.class.getCanonicalName() + " order by codeKindId", obj.getId())%>
			</select>
		</td>
	</tr>
	<tr>		

...
function init(){
	...
	form1.queryAll.click();
	form1.querySubmit.click();
	<% } %>
}
...
<form id="form1" name="form1" method="post" onSubmit="return checkField()" autocomplete="off" action="sysca201f.jsp?qauto=T">
<!--Query區============================================================-->

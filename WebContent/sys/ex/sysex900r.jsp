...
<body>
<form id="form1" name="form1" method="post" autocomplete="off" action="sysex900p.jsp">
	...
	<tr>
		...
		<tr>
			<td class="queryTDInput" colspan="2" style="text-align:center;">
				<input class="toolbar_default" followPK="false" type="button" name="btnSQLModel" value="產製SQL模式報表" onClick="setReportType(1);">
				<input class="toolbar_default" followPK="false" type="button" name="btnTableModel" value="產製Table Model模式報表" onClick="setReportType(2);">
			</td>			
		</tr>
	</table>
